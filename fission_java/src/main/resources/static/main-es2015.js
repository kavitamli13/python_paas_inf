...
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <app-header (newProjectObject) = \"newProjectObject($event)\"></app-header> -->\n<router-outlet></router-outlet>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-header [currentProjectObj]=\"currentProjectObj\" (newProjectObject) = \"newProjectObject($event)\"></app-header>\n\n<app-footer></app-footer>\n<router-outlet></router-outlet>\n\n\n\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>configuration works!</p>\n\n");
...
let AuthenticationService = class AuthenticationService {
    ...
    getHeadersForLogin(userName, password) {
...
let FunctionService = class FunctionService {
    ...
    getFunctionBuildLog(functionObj) {
        let headers = this.getHeadersAfterLogin(functionObj.projectName);
        let Headers = { headers: headers };
    ...
    getFunctionDescription(functionObj) {
        let headers = this.getHeadersAfterLogin(functionObj.projectName);
        let Headers = { headers: headers };
    ...
    */
    getHeadersAfterLogin(projectName) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers = headers.set('Content-Type', 'application/json');
        headers = headers.set('token', localStorage.getItem('token') + '');
        headers = headers.set('userId', localStorage.getItem('userId') + '');
...
let ProjectService = class ProjectService {
    ...
    deleteUserFromProject(projectObj) {
        let headers = this.getHeadersAfterLogin(projectObj.projectName);
        let Headers = { headers: headers };
        const requestOptions = {
            headers: headers,
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _authlayout_authlayout_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./authlayout/authlayout.component */ "./src/app/authlayout/authlayout.component.ts");
/* harmony import */ var _authlayout_login_login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./authlayout/login/login.component */ "./src/app/authlayout/login/login.component.ts");
...
/* harmony import */ var _root_configuration_configuration_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./root/configuration/configuration.component */ "./src/app/root/configuration/configuration.component.ts");
/* harmony import */ var _root_users_users_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./root/users/users.component */ "./src/app/root/users/users.component.ts");
/* harmony import */ var _projects_manage_manage_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./projects/manage/manage.component */ "./src/app/projects/manage/manage.component.ts");
/* harmony import */ var _projects_usage_usage_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./projects/usage/usage.component */ "./src/app/projects/usage/usage.component.ts");
/* harmony import */ var _function_create_create_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./function/create/create.component */ "./src/app/function/create/create.component.ts");
/* harmony import */ var _function_logs_logs_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./function/logs/logs.component */ "./src/app/function/logs/logs.component.ts");
/* harmony import */ var _projects_project_home_project_home_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./projects/project-home/project-home.component */ "./src/app/projects/project-home/project-home.component.ts");
...
const routes = [
    {
        ...
        children: [
            { path: 'login', component: _authlayout_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"] }
        ]
    },
    {
        path: 'projects',
        ...
        children: [
            { path: 'manage', component: _projects_manage_manage_component__WEBPACK_IMPORTED_MODULE_10__["ManageComponent"] },
            { path: 'usage', component: _projects_usage_usage_component__WEBPACK_IMPORTED_MODULE_11__["UsageComponent"] },
            { path: 'home', component: _projects_project_home_project_home_component__WEBPACK_IMPORTED_MODULE_14__["ProjectHomeComponent"] },
            { path: 'function', component: _function_create_create_component__WEBPACK_IMPORTED_MODULE_12__["CreateComponent"] },
            { path: 'function/logs', component: _function_logs_logs_component__WEBPACK_IMPORTED_MODULE_13__["LogsComponent"] }
        ]
    },
    // { path: 'projects/home', component: ManageComponent },
    {
        path: 'root', component: _root_root_component__WEBPACK_IMPORTED_MODULE_6__["RootComponent"],
        children: [
            { path: 'users', component: _root_users_users_component__WEBPACK_IMPORTED_MODULE_9__["UsersComponent"] },
            { path: 'configuration', component: _root_configuration_configuration_component__WEBPACK_IMPORTED_MODULE_8__["ConfigurationComponent"] }
        ]
    },
...
/* harmony import */ var _authlayout_authlayout_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./authlayout/authlayout.component */ "./src/app/authlayout/authlayout.component.ts");
/* harmony import */ var _authlayout_login_login_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./authlayout/login/login.component */ "./src/app/authlayout/login/login.component.ts");
...
/* harmony import */ var _root_root_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./root/root.component */ "./src/app/root/root.component.ts");
...
/* harmony import */ var _layout_common_header_header_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./layout/common/header/header.component */ "./src/app/layout/common/header/header.component.ts");
/* harmony import */ var _layout_common_footer_footer_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./layout/common/footer/footer.component */ "./src/app/layout/common/footer/footer.component.ts");
/* harmony import */ var _layout_common_leftsidenav_leftsidenav_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./layout/common/leftsidenav/leftsidenav.component */ "./src/app/layout/common/leftsidenav/leftsidenav.component.ts");
/* harmony import */ var _root_users_users_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./root/users/users.component */ "./src/app/root/users/users.component.ts");
/* harmony import */ var _root_configuration_configuration_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./root/configuration/configuration.component */ "./src/app/root/configuration/configuration.component.ts");
/* harmony import */ var _projects_manage_manage_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./projects/manage/manage.component */ "./src/app/projects/manage/manage.component.ts");
/* harmony import */ var _function_function_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./function/function.component */ "./src/app/function/function.component.ts");
/* harmony import */ var _function_create_create_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./function/create/create.component */ "./src/app/function/create/create.component.ts");
/* harmony import */ var _projects_usage_usage_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./projects/usage/usage.component */ "./src/app/projects/usage/usage.component.ts");
/* harmony import */ var _function_logs_logs_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./function/logs/logs.component */ "./src/app/function/logs/logs.component.ts");
/* harmony import */ var _function_deploy_deploy_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./function/deploy/deploy.component */ "./src/app/function/deploy/deploy.component.ts");
/* harmony import */ var _layout_common_project_header_project_header_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./layout/common/project-header/project-header.component */ "./src/app/layout/common/project-header/project-header.component.ts");
/* harmony import */ var _projects_project_home_project_home_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./projects/project-home/project-home.component */ "./src/app/projects/project-home/project-home.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _authlayout_authlayout_component__WEBPACK_IMPORTED_MODULE_9__["AuthlayoutComponent"],
            _authlayout_login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"],
            _projects_projects_component__WEBPACK_IMPORTED_MODULE_11__["ProjectsComponent"],
            _root_root_component__WEBPACK_IMPORTED_MODULE_12__["RootComponent"],
            _layout_layout_component__WEBPACK_IMPORTED_MODULE_13__["LayoutComponent"],
            _layout_common_header_header_component__WEBPACK_IMPORTED_MODULE_14__["HeaderComponent"],
            _layout_common_footer_footer_component__WEBPACK_IMPORTED_MODULE_15__["FooterComponent"],
            _layout_common_leftsidenav_leftsidenav_component__WEBPACK_IMPORTED_MODULE_16__["LeftsidenavComponent"],
            _root_users_users_component__WEBPACK_IMPORTED_MODULE_17__["UsersComponent"],
            _root_configuration_configuration_component__WEBPACK_IMPORTED_MODULE_18__["ConfigurationComponent"],
            _projects_manage_manage_component__WEBPACK_IMPORTED_MODULE_19__["ManageComponent"],
            _function_function_component__WEBPACK_IMPORTED_MODULE_20__["FunctionComponent"],
            _function_create_create_component__WEBPACK_IMPORTED_MODULE_21__["CreateComponent"],
            _projects_usage_usage_component__WEBPACK_IMPORTED_MODULE_22__["UsageComponent"],
            _function_logs_logs_component__WEBPACK_IMPORTED_MODULE_23__["LogsComponent"],
            _function_deploy_deploy_component__WEBPACK_IMPORTED_MODULE_24__["DeployComponent"],
            _layout_common_project_header_project_header_component__WEBPACK_IMPORTED_MODULE_25__["ProjectHeaderComponent"],
            _projects_project_home_project_home_component__WEBPACK_IMPORTED_MODULE_26__["ProjectHomeComponent"]
        ],
        imports: [
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _services_spinner_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/spinner.service */ "./src/app/_services/spinner.service.ts");
...
let AuthlayoutComponent = class AuthlayoutComponent {
    constructor(spinnerService, alertService) {
    ...
    ngOnInit() {
        this.spinnerService.status.subscribe((val) => {
            this.showLoader = val;
        });
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, route, router, authenticationService, alertConfig) {
...
/* harmony import */ var src_app_services_function_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/function.service */ "./src/app/_services/function.service.ts");
/* harmony import */ var src_app_services_project_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/project.service */ "./src/app/_services/project.service.ts");
/* harmony import */ var _model_function__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../_model/function */ "./src/app/_model/function.ts");
...
let CreateComponent = class CreateComponent {
    constructor(route, formBuilder, functionService, router, modalService, alertConfig, projectService) {
        this.route = route;
        this.formBuilder = formBuilder;
        ...
        this.createFunctionForm = this.formBuilder.group({
            functionName: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(25),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(2),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^[a-z0-9_-]+$')])],
    ...
    listProjects() {
        ...
        this.projectService.listProjects(this.userId).subscribe((data) => {
            ...
            for (let project of this.projectsList) {
                if (this.projectName == project['projectName']) {
                    if (project['projectRoleName'] == "PROJECT_VIEWER") {
                        ...
                        this.functionService.listFunctions(this.projectName).subscribe((data) => {
    ...
    getFunctionDescription() {
        ...
        this.functionService.getFunctionDescription(functionObj).subscribe((data) => {
    ...
    createFunction() {
        ...
        this.functionService.createFunction(functionObj).subscribe((data) => {
            console.log(data);
            this.userMsg = null;
            this.deployFlag = true;
    ...
    viewErrorLog() {
        ...
        functionObj.projectName = this.projectName;
        functionObj.functionName = this.functionName;
        this.functionService.getFunctionBuildLog(functionObj).subscribe((data) => {
    ...
    deployFunction() {
        ...
        this.functionService.deployFunction(functionObj).subscribe((data) => {
...
let LogsComponent = class LogsComponent {
    constructor(route, formBuilder, functionService, alertConfig, router, projectService) {
        this.route = route;
        this.formBuilder = formBuilder;
        this.functionService = functionService;
        this.alertConfig = alertConfig;
    ...
    getFunctionLogs() {
        ...
        this.functionService.getFunctionLogs(functionObj).subscribe((data) => {
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_project_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/project.service */ "./src/app/_services/project.service.ts");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
...
let HeaderComponent = class HeaderComponent {
    constructor(authenticationService, router, projectService, modalService, formBuilder, route, alertConfig) {
        this.authenticationService = authenticationService;
        this.router = router;
        this.projectService = projectService;
        this.modalService = modalService;
        ...
        this.createProjectForm = this.formBuilder.group({
            ...
            projectName: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].maxLength(25),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].minLength(2),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].pattern('^[a-z0-9_-]+$')])]
        });
        this.submitted = false;
        this.projectName = "";
        this.userId = "";
    ...
    listProjects(userId) {
        this.projectService.listProjects(userId).subscribe((data) => {
            this.projectsList = data;
...
], HeaderComponent.prototype, "currentProjectObj", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], HeaderComponent.prototype, "newProjectObject", void 0);
...
let LeftsidenavComponent = class LeftsidenavComponent {
    constructor() { }
    ngOnInit() {
    }
};
LeftsidenavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProjectHeaderComponent", function() { return ProjectHeaderComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_authentication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../_services/authentication.service */ "./src/app/_services/authentication.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ProjectHeaderComponent = class ProjectHeaderComponent {
    constructor(authenticationService, router, projectService, modalService, formBuilder) {
        this.authenticationService = authenticationService;
        this.router = router;
        this.projectService = projectService;
        this.modalService = modalService;
...
ProjectHeaderComponent.ctorParameters = () => [
    { type: _services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: src_app_services_project_service__WEBPACK_IMPORTED_MODULE_4__["ProjectService"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModal"] },
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ProjectHeaderComponent.prototype, "newProjectObject", void 0);
ProjectHeaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var src_app_model_project__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_model/project */ "./src/app/_model/project.ts");
/* harmony import */ var src_app_services_project_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/project.service */ "./src/app/_services/project.service.ts");
...
let ManageComponent = class ManageComponent {
    constructor(formBuilder, route, projectService, router, modalService, alertConfig) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.projectService = projectService;
        this.router = router;
    ...
    getProjectRoles() {
        this.projectService.getProjectRoles(this.projectName).subscribe((data) => {
    ...
    getProjectUsers() {
        this.projectService.getProjectInfo(this.projectName).subscribe((data) => {
    ...
    editUserRole() {
        ...
        this.projectService.modifyUserRole(projectObj).subscribe((data) => {
            this.alertMsg = data['message'];
    ...
    deleteUser(user) {
        ...
        this.projectService.deleteUserFromProject(projectObj).subscribe((data) => {
            this.alertMsg = data['message'];
            this.alertConfiguration("success");
            this.getProjectUsers();
        }, err => {
    ...
    deleteProject() {
        var projectObj = new src_app_model_project__WEBPACK_IMPORTED_MODULE_4__["Project"]();
        projectObj.projectName = this.projectName;
        this.projectService.deleteProject(projectObj).subscribe((data) => {
            this.router.navigateByUrl('projects');
        }, err => {
            //alert("Something Went wrong);
            //this.loginError = true;
...
/* harmony import */ var _services_function_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../_services/function.service */ "./src/app/_services/function.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
...
let ProjectHomeComponent = class ProjectHomeComponent {
    constructor(projectService, functionService, formBuilder, modalService, route) {
        this.projectService = projectService;
        this.functionService = functionService;
        this.formBuilder = formBuilder;
        this.modalService = modalService;
    ...
    listFunctions(projectName) {
        this.functionService.listFunctions(projectName).subscribe((data) => {
    ...
    deleteFunction(functionObj) {
        ...
        functionObj.projectName = this.projectName;
        this.functionService.deleteFunction(functionObj).subscribe((data) => {
            this.listFunctions(this.projectName);
            console.log("Functions List :", this.functionsList);
        }, err => {
            //alert("Something Went wrong);
...
ProjectHomeComponent.ctorParameters = () => [
...
ProjectHomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _model_project__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_model/project */ "./src/app/_model/project.ts");
...
/* harmony import */ var _services_function_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_services/function.service */ "./src/app/_services/function.service.ts");
...
let ProjectsComponent = class ProjectsComponent {
    constructor(projectService, functionService, formBuilder, modalService, route, router) {
        this.projectService = projectService;
        this.functionService = functionService;
        this.formBuilder = formBuilder;
        this.modalService = modalService;
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_model_project__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_model/project */ "./src/app/_model/project.ts");
/* harmony import */ var src_app_services_project_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/project.service */ "./src/app/_services/project.service.ts");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
...
let UsageComponent = class UsageComponent {
    constructor(route, projectService, router, alertConfig) {
        this.route = route;
        this.projectService = projectService;
        this.router = router;
        this.alertConfig = alertConfig;
    ...
    getProjectUsage() {
        ...
        projectObj.projectName = this.projectName;
        this.projectService.getProjectUsage(projectObj).subscribe((data) => {
...
let UsersComponent = class UsersComponent {
    constructor(formBuilder, route, router, authenticationService, modalService, alertConfig) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.authenticationService = authenticationService;
    ...
    getUserRoles() {
        this.authenticationService.getUserRoles().subscribe((data) => {
            this.userRoles = data;
    ...
    getAllUsers() {
        this.authenticationService.listUsersOfOrg().subscribe((data) => {
            this.usersList = data;
    ...
    refreshPagination() {
        this.paginatedData = this.usersList
            .map((user, i) => (Object.assign({ id: i + 1 }, user)))
            .slice((this.currentPage - 1) * this.pageSize, (this.currentPage - 1) * this.pageSize + this.pageSize);
    }
    deleteUser(user) {
        this.authenticationService.deleteUserFromOrg(user).subscribe((data) => {
            this.getAllUsers();
