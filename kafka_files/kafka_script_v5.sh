...
spec:
  ...
  kafka:
    config:
      ...
      controller.quorum.voters: 0@${CLUSTER_NAME}-controllers-0.${CLUSTER_NAME}-kafka-bootstrap.${KAFKA_NS}.svc:9093,1@${CLUSTER_NAME}-controllers-1.${CLUSTER_NAME}-kafka-bootstrap.${KAFKA_NS}.svc:9093,2@${CLUSTER_NAME}-controllers-2.${CLUSTER_NAME}-kafka-bootstrap.${KAFKA_NS}.svc:9093
      listeners: INTERNAL://:9092
      advertised.listeners: INTERNAL://${CLUSTER_NAME}-kafka-bootstrap.${KAFKA_NS}.svc:9092
